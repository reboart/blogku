...
<div class="row">
	...
	<div class="main">
		<section id="breadcrumbs" class="breadcrumbs">
			<li><a>Home </a></li>
			<li><span> » </span><?php the_category(',');?></li>
		...
		<main id="primary" class="site-main-single">
			...
			while ( have_posts() ) :
				...
				the_post_navigation(
					array(
						'prev_text' => '<span class="nav-subtitle">' . esc_html__( 'Previous:', 'template-blogku-fast' ) . '</span> <span class="nav-title">%title</span>',
						'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'template-blogku-fast' ) . '</span> <span class="nav-title">%title</span>',
					)
				);
